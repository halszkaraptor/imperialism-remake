 ...
 *
 * <p>Overriding classes must provide a constructor that calls the protected
...
public abstract class TSimpleFormatConversionProvider extends TFormatConversionProvider {
    ...
    /**
     * Disables this FormatConversionProvider. This may be useful when e.g.
     * native libraries are not present. TODO: enable method, better
     * implementation
     */
    ...
    /**
     * Utility method to check whether these values match, taking into account
     * AudioSystem.NOT_SPECIFIED.
     *
     * @return true if any of the values is AudioSystem.NOT_SPECIFIED or both
    ...
    /**
     * Utility method, replaces all occurences of AudioSystem.NOT_SPECIFIED in
     * <code>targetFormat</code> with the corresponding value in
     * <code>sourceFormat</code>. If
     * <code>targetFormat</code> does not contain any fields with
     * AudioSystem.NOT_SPECIFIED, it is returned unmodified. The endian-ness and
     * encoding remain the same in all cases. <p> If any of the fields is
     * AudioSystem.NOT_SPECIFIED in both
     * <code>sourceFormat</code> and
     * <code>targetFormat</code>, it will remain not specified. <p> This method
     * uses
     * <code>getFrameSize(...)</code> (see below) to set the new frameSize, if a
     * new AudioFormat instance is created. <p> This method isn't used in
     * TSimpleFormatConversionProvider - it is solely there for inheriting
     * classes.
     */
    //$$fb 2000-08-16: moved from TEncodingFormatConversionProvider
     ...
     * <code>sampleSize</code> or
     * <code>channels</code> is AudioSystem.NOT_SPECIFIED, otherwise
     * <code>sampleSize*channels/8</code> is returned. <p> If this does not
     * reflect the way to calculate the right frame size, inheriting classes
     * should overwrite this method if they use replaceNotSpecified(...). It is
