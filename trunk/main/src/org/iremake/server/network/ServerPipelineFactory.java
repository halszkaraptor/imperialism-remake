...
public class ServerPipelineFactory implements ChannelPipelineFactory {
    ...
    public ChannelPipeline getPipeline() throws Exception {
        ...
        p.addLast("protobufDecoder", new ProtobufDecoder(Messages.Msg.getDefaultInstance())); // TODO need message prototype??
        ...
        // working on messages
        p.addLast("handler", new ServerHandler(new LoggingDebugConsole()));
        return p;
    }
}
