 ...
 */
package org.tools.ui.application;
...
import org.tools.ui.common.ToolsFrame;
...
public class TableEditorFrame extends ToolsFrame {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fileChooser.showOpenDialog(TableEditorFrame.this) == JFileChooser.APPROVE_OPTION) {
                    ...
                    try (InputStream is = new FileInputStream(f)) {
                        ...
                        NotificationFactory.createInfoPane(TableEditorFrame.this, "Loading failed.");
                        return;
                    }
                    // initialize from xml
                    model.fromXML(xml);
                    NotificationFactory.createInfoPane(TableEditorFrame.this, "Table loaded.");
                }
            }
        });
